...
public class UserRoleDto implements Serializable {
    ...
    public static final UserRoleDto ROLE_ADMIN = new UserRoleDto(1L, "内置分组", "ROLE_ADMIN");
    public static final UserRoleDto ROLE_AUTHENTICATED = new UserRoleDto(2L, "内置分组", "ROLE_AUTHENTICATED");
    public static final UserRoleDto ROLE_ANONYMOUS = new UserRoleDto(3L, "内置分组", "ROLE_ANONYMOUS");
    /**
     * 角色id
     */
    private Long id;
