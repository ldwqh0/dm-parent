...
/**
 * If authentication fails and the caller has asked for a specific content type
 * response, this entry point can send one, along with a standard 401 status.
 * Add to the Spring Security configuration as an
