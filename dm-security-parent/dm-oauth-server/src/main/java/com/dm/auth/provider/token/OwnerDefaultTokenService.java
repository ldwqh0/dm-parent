...
/**
 * 一个 {@link DefaultTokenService}的实现<br />
 * 修改了，当OWNER_APP登录时，始终会刷新token
 * 
 * @author LiDong
 *
 */
public class OwnerDefaultTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices,
        ConsumerTokenServices, InitializingBean {
    private static final String OWNER_APP = "ownerapp";
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        if (existingAccessToken != null) {
            ...
            if (existingAccessToken.isExpired() ||
                    (OWNER_APP).equals(authentication.getOAuth2Request().getClientId())) {
