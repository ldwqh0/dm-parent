...
public final class AuthorizationServerEndpointsConfigurer {
    ...
    /**
     * Explicitly disable the approval store, even if one would normally be added
     * automatically (usually when JWT is not used). Without an approval store the
     * user can only be asked to approve or deny a grant without any more granular
     * decisions.
     * 
    ...
    public AuthorizationServerEndpointsConfigurer exceptionTranslator(
    ...
    /**
     * N.B. this method is not part of the public API. To set up a custom
     * ClientDetailsService please use
