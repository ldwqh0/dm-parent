...
public class AuthorizationEndpoint extends AbstractEndpoint {
    ...
    public ModelAndView authorize(Map<String, Object> model, @RequestParam Map<String, String> parameters,
        ...
        try {
            ...
            // Store authorizationRequest AND an immutable Map of authorizationRequest in
            // session
    ...
    public View approveOrDeny(@RequestParam Map<String, String> approvalParameters, Map<String, ?> model,
        ...
        // Check to ensure the Authorization Request was not modified during the user
        // approval step
    ...
    private ModelAndView getImplicitGrantResponse(AuthorizationRequest authorizationRequest) {
        try {
            ...
            RedirectView redirectView = new RedirectView(appendAccessToken(authorizationRequest, accessToken), false,
                    true,
                    false);
            redirectView.setStatusCode(HttpStatus.SEE_OTHER);
    ...
    private View getAuthorizationCodeResponse(AuthorizationRequest authorizationRequest, Authentication authUser) {
        try {
            ...
            RedirectView redirectView = new RedirectView(getUnsuccessfulRedirect(authorizationRequest, e, false), false,
                    true, false);
            redirectView.setStatusCode(HttpStatus.SEE_OTHER);
            return redirectView;
        }
