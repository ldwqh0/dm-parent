...
/**
 * If authorization fails and the caller has asked for a specific content type
 * response, this entry point can send one, along with a standard 403 status.
 * Add to the Spring Security configuration as an {@link AccessDeniedHandler} in
 * the usual way.
 *
 * <p>
 * See the <a href=
