...
public final class AuthorizationServerSecurityConfigurer extends
    ...
    /**
     * Adds a new custom authentication filter for the TokenEndpoint. Filters will
     * be set upstream of the default BasicAuthenticationFilter.
     * 
     * @param filter
     */
     ...
     * Filters will be set upstream of the default BasicAuthenticationFilter.
     * 
