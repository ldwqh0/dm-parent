 ...
 * {@link org.springframework.security.oauth2.common.OAuth2AccessToken} with
 * jackson2 by implementing
 * {@link com.fasterxml.jackson.databind.JsonDeserializer}.
 * </p>
 * <p>
 * The expected format of the access token is defined by <a href=
 * "https://tools.ietf.org/html/draft-ietf-oauth-v2-22#section-5.1">Successful
 * Response</a>.
 * </p>
 *
 * <p>
...
public final class OAuth2AccessTokenJackson2Deserializer extends StdDeserializer<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
        ...
        // TODO What should occur if a required parameter (tokenValue or tokenType) is
        // missing?
